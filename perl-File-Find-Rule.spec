%{?scl:%scl_package perl-File-Find-Rule}

Name: 		%{?scl_prefix}perl-File-Find-Rule
Version: 	0.34
Release: 	14%{?dist}
...
BuildRequires: 	%{?scl_prefix}perl(Number::Compare)
BuildRequires: 	%{?scl_prefix}perl(Text::Glob)
BuildRequires:  %{?scl_prefix}perl(Test::More) >= 0.07
...
%changelog
* Fri Jan 03 2020 Jitka Plesnikova <jplesnik@redhat.com> - 0.34-14
- SCL
